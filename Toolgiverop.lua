...
-- Floating Button (unten links) - immer sichtbar
...
-- Floating Button abrunden (Kreis)
local floatingCorner = Instance.new("UICorner")
floatingCorner.CornerRadius = UDim.new(1, 0) -- Macht es zu einem Kreis
...
-- Pulse Animation für Floating Button
spawn(function()
    while true do
...
mainFrame.Visible = false -- Startet geschlossen
mainFrame.ZIndex = 10
...
-- Close Button (schließt zum Floating Button)
...
scanBtn.Size = UDim2.new(0.5, -6, 0, 50) -- Größer für Mobile
...
local function addToolToList(toolName, toolInstance, isRubox)
    ...
    toolButton.Size = UDim2.new(1, -10, 0, 40) -- Größer für Mobile
...
-- Minimize Funktion (optional - minimiert das GUI)
...
-- Floating Button kann auch verschoben werden (optional)
...
print("✅ OP ToolGiver mit RUBOX Support und Floating Button geladen! Made by Waled-hammad")
setStatus("🟢 Bereit - Klicke auf den ⚡ Button zum Öffnen", true)
